...
public class UnusedPrivateMethodTest extends SemanticTest {
    ...
    public void should_not_remove_method_when_it_is_writeObject() throws Exception {
        CompilationUnit cu = compile(
                "import java.io.*; public class Foo{ private void writeObject(ObjectOutputStream s) throws IOException {} } ");
    ...
    public void should_not_remove_method_when_it_is_readObject() throws Exception {
        CompilationUnit cu = compile(
                "import java.io.*; public class Foo{ private void readObject(ObjectInputStream s) throws IOException {} } ");
