...
public class CheckResultSetTest extends SemanticTest {
    ...
    public void testParams() throws Exception {
        CompilationUnit cu = compile(
                "import java.sql.ResultSet; public class Foo{ public void bar(ResultSet rs) throws Exception{ rs.next();  String firstName = rs.getString(1); } }");
    ...
    public void testVars() throws Exception {
        CompilationUnit cu = compile(
                "import java.sql.ResultSet; public class Foo{ ResultSet aux; public void bar() throws Exception{ ResultSet rs = aux; rs.next();  String firstName = rs.getString(1); } }");
        CheckResultSet visitor = new CheckResultSet();
        visitor.visit(cu, cu);
